...
var _tileMap = [
  {
    ...
    "map": [
      ...
      [[0,8],[4,9],[0,4],[0,3],[4,4],[0,6],[0, 8],[0,4]],
      [[0,11],[0,4],[0,12],[0,4],[0,14],[0,6]],
      [[0,16],[8, 8],[4,13],[0,8],[0,11]],
      [[0,4],[0,9],[4,10]],
      [[0,48]],
      [[1,13]]
    ]
  ...
  },
  {
    "level": 3,
    "map": [
      [[0,1],[0,1],[0,1],[0,1],[0,7],[0,6],[0,9],[0,4],[0,2],[0,1]],
      [[0,8],[0,1],[0,3],[0,1],[8,6],[0,1],[8,23]],
      [[0,8],[4,19],[0,1],[4,3],[0,1],[0,6],[0,1],[0,4]],
      [[0,11],[0,1],[0,12],[0,1],[0,14],[4,6]],
      [[0,16],[8,1],[0,13],[8,1],[4,11]],
      [[4,9],[0,1],[8,37]],
      [[1,48]],
      [[1,48]]
    ]
  },
  {
    "level": 4,
    "map": [
      [[0,1],[0,1],[0,1],[0,1],[0,7],[0,6],[8,9],[0,4],[0,2],[0,1]],
      [[0,8],[0,1],[8,3],[0,1],[8,6],[0,1],[8,23]],
      [[0,8],[4,19],[0,1],[4,3],[0,1],[0,6],[0,1],[0,4]],
      [[0,11],[0,1],[0,12],[0,1],[0,14],[4,6]],
      [[0,16],[8,1],[0,13],[8,1],[4,11]],
      [[4,9],[4,1],[8,37]],
  ...
  "level": 5,
  "map": [
    [[4,1],[0,1],[0,1],[0,1],[0,7],[0,6],[8,9],[0,4],[0,2],[1,1]],
    [[0,8],[0,1],[8,3],[0,1],[8,6],[0,1],[8,23]],
    [[0,8],[4,19],[0,1],[4,3],[0,1],[0,6],[0,1],[4,4]],
    [[0,11],[8,1],[0,12],[0,1],[0,14],[4,6]],
    [[0,16],[0,1],[0,13],[0,1],[4,11]],
    [[8,9],[0,1],[0,37]],
    [[0,48]],
    [[1,5], [1,3], [4,1]]
  ]
...
Crafty.init(800, 800, document.getElementById('gamecanvas'));

setupGlobalBindings();

var assets = {'tiles': ['img/tile-1.png', 'img/platform.png', 'img/platformx2.png', 'img/sun.png']};
var playerSprite = { 'sprites': { 'img/player.png': { tile: 68, tileh: 80, map: { man_left: [2, 4], man_right: [2, 1], jump_right: [4, 1] } } } };
var bullet = { 'sprites': { 'img/bullet.png': { tile: 12, tileh: 12, map: { bullet_right: [0, 0]} } } };
...
Crafty.audio.add("die", "sounds/die.wav");
Crafty.audio.add("song", "sounds/doyoubelieveinmagic.wav");
Crafty.audio.add("enemyDie", "sounds/enemyDie.wav");
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('moveRight', 500, [[0, 0], [1, 0], [2, 0], [3, 0], [4, 0], [0, 1]])
    .reel('moveLeft', 500, [[0, 2], [1, 2], [2, 2], [3, 2], [4, 2], [0, 3]])
    .reel('jumpRight', 500, [[2, 1], [3, 1], [4,1]])
    .reel('jumpLeft', 500, [[2, 3], [3, 3], [4, 3]])
    .twoway(PLAYER_SPEED*TILE_WIDTH, 510)
    .gravity('FloorTile')
    ...
    .bind('KeyDown',
      function (e) {
        ...
        if (this.currentDirection === RIGHT) {
          Crafty.e('Bullet, 2D, DOM, bullet_right, Collision, Tween')
          .attr({x: this.x, y: this.y+50})
          .tween({x: this.x+100000}, 150000
          )
        }
        else {
        Crafty.e('Bullet, 2D, DOM, bullet_right, Collision, Tween')
