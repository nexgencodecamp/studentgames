...
var _tileMap = [
  ...
  },
  {
    "level": 2,
    "map": [
      [[8,1],[0,1],[0,12],[0,1],[0,8],[0,1],[0,5],[0,1],[0,5],[0,1]],
      [[0,8],[0,1],[0,3],[0,1],[0,6],[0,1],[0,23]],
      [[0,8],[4,1],[0,1],[4,1],[0,1],[4,1],[0,1],[0,6],[0,1],[0,4]],
...
{    "level": 5,
    "map": [
      [[0,15],[4,1]],
      [[0,18],[0,4],[4,1]],
      [[0,12],[1,4],[1,4],[0,3],[0,1]],
      [[0,9],[4,1],[0,3],[0,15],[8,1]],
      [[0,6],[0,1],[0,5],[0,1],[0,10],[4,1]],
      [[8,1],[0,3],[4,1],[0,5],[4,1]],
      [[0,48]],
      [[0,16], [1,16]]
    ]
...
var playerSprite = { 'sprites': { 'img/myGuy.png': { tile: 68, tileh: 80, map: { man_left: [0, 1], man_right: [0, 2], jump_right: [6, 4] } } } };
...
function initialiseGame () {
  Crafty.load(assets, function(){
    ...
    Crafty.audio.add("tardis", "sounds/tardisSound.wav");
...
function loadBackground () {
  Crafty.background('#222 url(img/bg.png)');
}
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('landed', 500, [[16,0], [17,0], [16,0], [17,0], [16,0]])
    .twoway(200, 510)
    .gravity('FloorTile')
    ...
    .bind('CheckJumping', function (ground) {
      ...
      this.resetAnimation();
      //this.animate('jump', 1)
      this.sprite(this.currentDirection === RIGHT ? 6 : 17, 0);
    })
...
function spawnGoal() {
  _goalFinish = false;
  Crafty.e('Goal, 2D, DOM, goal, Image, Collision')
    .attr({
      x: (32 * TILE_WIDTH) ,
      y: (5 * TILE_HEIGHT) - 154 ,
      w: 80 ,
