...
var _tileMap = [
  {
    ...
    "map": [
      ...
      [[0,11],[0,4],[4,1],[0,16],[0,14],[0,6]],       //Tick
  ...
  },
  {
    ...
    "map": [
      ...
      [[4,2],[0,5],[8,3],[0,1],[8,1],[0,6],[4,1]],    //Tick
      [[0,25],[8,1]],
      [[0,34],[0,13],[0,12]],
  ...
  },
  {
    ...
    "map": [
      [[0,1],[0, 8],[0,13],[0,4],[0,8],[0, 8],[0,5],[0,4],[0,5],[0, 8]],
      [[0,8],[0,4],[0,3],[0,4],[0,6],[0, 8],[0,23]],
      [[0,8],[0,26],[4, 1], [0,4],[0,1],[0,4],[0,6],[0, 8],[0,4]],          //Tick
      [[0,11],[0,4],[0,1],[0,4],[0,14],[0,6]],
      [[0,4],[8, 1],[0,4], [8,1],[0,4], [8,1],[0,4], [8,1], [0, 8],[0,11]],
      [[1,3],[0,9],[0,2]],
      [[0,48]],
      [[0,10], [1, 3]]
    ]
  ...
  },
  {
    ...
    "map": [
      [[4,2]],
      [[0,5],[4,1]],
      [[0,10],[4,1],[0,5],[4,1],[0,5],[4,1],[0,5],[4,1],[0,5],[4,1],[0,5]],
      [[0,40],[4,1]],
      [[0,45],[4,1]],
      [[0,15]],
      [[0,30]],
      [[1,3],[0,5],[1,5],[0,5],[1,5],[0,5],[1,5],[0,5],[1,5]]
    ]
  },
...
__STATE.numberOfCoins = 0;

const PLAYER_SPEED = 4;
const WALKER_VELOCITY = 60;
...
Crafty.init(1200, 575, document.getElementById('gamecanvas'));

setupGlobalBindings();

var assets = {'tiles': ['img/tile-1.png', 'img/platform.png', 'img/platformx2.png', 'img/sun.png']};
var playerSprite = { 'sprites': { 'img/spritePlayer.png': { tile: 68, tileh: 80, map: { man_left: [15, 0], man_right: [6, 0], jump_right: [4, 0] } } } };
...
function initialiseGame () {
  Crafty.load(assets, function(){
    ...
    Crafty.audio.add("fly", "sounds/fly.wav");
    Crafty.audio.add("fly2", "sounds/fly2.wav");
    Crafty.audio.add("bgm", "sounds/bgm.wav");
    Crafty.audio.add("death", "sounds/playerie.wav");
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('moveLeft', 500, [[8, 0], [9, 0], [10, 0], [11, 0], [12, 0]])
    .reel('jumpRight', 500, [[15, 0], [16, 0], [17, 0], [18, 0], [19, 0], [15, 0], [16, 0], [17, 0], [18, 0], [19, 0], [15, 0], [16, 0], [17, 0], [18, 0], [19, 0]])
    .reel('jumpLeft', 400, [[15, 0], [16, 0], [17, 0], [18, 0], [19, 0], [15, 0], [16, 0], [17, 0], [18, 0], [19, 0], [15, 0], [16, 0], [17, 0], [18, 0], [19, 0]])
    .reel('landed', 500, [[4,0]])
    .twoway(200, 510)
    .gravity('FloorTile')
    ...
    .bind('LandedOnGround', function (ground) {
      if (this.isJumping) {
        ...
        this.sprite(this.getReel().id === 'moveRight' ? 5 : 16);
...
function spawnWalkers () {
  Crafty.e('Delay').delay(spawnWalker, Crafty.math.randomInt(600, 800), 10);
}
...
/*function displayTimeLeft () {
  ...
  _timeLeftDisplay = Crafty.e("2D, DOM, Text")
    ...
    .textColor('#FF0000')
    .textFont({ size: '21px', weight: 'bold', family: 'Cambria' });
}*/
...
function displayScore () {
  ...
  _scoreDisplay = Crafty.e("2D, DOM, Text")
    .attr({ x: 800 - Crafty.viewport._x, y: 20 })
    .text(pad('Number of COINS: '+__STATE.currentScore+'/'+__STATE.numberOfCoins, 1))
    .textColor('#FF0000')
    .textFont({ size: '21px', weight: 'bold', family: 'Cambria' });
     // if(__STATE.levelComplete)
    //__STATE.currentScore='0';
...
function reset () {
  ...
  _timeLeftDisplay = "";
  //_secondsTotal = 60 - __STATE.level * 5;
