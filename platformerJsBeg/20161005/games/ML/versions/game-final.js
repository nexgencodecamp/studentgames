...
var _tileMap = [
  ...
  },
  {
    "level": 2,
    "map": [
      [[4,1],[0,3],[0,6],[0,7],[0,5],[0,3],[0,2],[0,4],[0,2],[0,2]],
      [[0,6],[4,1],[0,5],[0,1],[0,6],[0,1],[0,23]],
  ...
  "level": 3,
  "map": [
    [[4,1],[0,1],[0,6],[0,7],[0,8],[0,1],[0,5],[4,1],[0,5],[0,1]],
    [[4,6],[4,1],[0,5],[0,1],[0,6],[0,1],[4,23]],
    [[0,8],[0,19],[8,1],[0,3],[0,1],[0,6],[4,1],[0,4]],
    [[0,11],[0,1],[0,12],[0,1],[0,14],[0,6]],
    [[0,16],[8,1],[0,13],[8,1],[0,11]],
    [[8,9],[4,1],[0,37]],
    [[0,48]],
...
},
{
  "level": 4,
  "map": [
    [[4,1],[0,1],[0,6],[0,7],[0,8],[0,1],[4,3],[0,3],[4,2],[0,4]],
    [[4,5],[4,3],[0,4],[0,2],[4,4],[0,13],[4,11]],
    [[0,8],[0,19],[4,1],[0,3],[4,1],[0,6],[0,1],[0,4]],
    [[0,11],[4,1],[0,12],[0,1],[0,14],[4,6]],
    [[0,16],[8,1],[0,13],[8,1],[0,11]],
    [[4,9],[4,1],[0,37]],
    [[0,48]],
    [[1,48]]
...
},
{
  "level": 5,
  "map": [
    [[0,7],[8,8],[0,6],[8,5],[4,1],[0,8]],
      [[4,2],[0,5],[8,3],[0,1],[8,1],[0,6],[4,1]],
      [[0,25],[8,1]],
      [[0,34],[0,13],[0,12]],
      [[0,3],[0,1],[4,3],[8,1],[0,9],[4,1]],
      [[0,47]],
      [[0,48]],
      [[1,10],[0,38]]
  ]
...
},
{
  ...
  },
  {
    ...
    "map": [
      [[0,1],[0, 8],[0,13],[0,4],[0,8],[0, 8],[0,5],[0,4],[0,5],[0, 8]],
      [[0,8],[0,4],[0,3],[0,4],[0,6],[0, 8],[0,23]],
      [[0,8],[0,19],[0,4],[0,1],[0,4],[0,6],[0, 8],[0,4]],
      [[0,11],[0,4],[4,1],[0,16],[0,14],[0,6]],
      [[0,4],[8, 1],[0,20],[0, 8],[0,11]],
      [[4,1],[0,9],[8,2]],
      [[0,48]],
      [[1,48]]
    ]
  ...
  },
  {
    "level": 10,
    "map": [
      [[0,1],[0, 8],[0,13],[0,4],[8,8],[4, 8],[4,5],[4,4],[0,5],[8, 8]],
      [[0,8],[0,4],[0,3],[0,4],[4,6],[0, 8],[4,23]],
      [[8,8],[0,19],[0,4],[0,1],[0,4],[4,6],[0, 8],[4,4]],
      [[0,11],[0,4],[4,1],[4,16],[0,14],[4,6]],
      [[0,4],[4, 1],[4,20],[0, 8],[0,11]],
      [[4,1],[0,9],[8,2]],
      [[0,48]],
      [[1,12],[0,3],[0,12],[0,11],[0,5],[4,3],[0,2]]
    ]
  }
];
...
var playerSprite = { 'sprites': { 'img/articuno.png': { tile: 64, tileh: 64, map: { man_left: [0, 1], man_right: [0, 2], jump_right: [6, 4] } } } };
var ShadowBallSprite = { 'sprites': { 'img/icebeam.png': { tile: 200, tileh: 198, map: { shadow_left: [0, 2]} } } };
initialiseGame();
...
function initialiseGame () {
  Crafty.load(assets, function(){
    ...
    /* Load sounds */
    Crafty.audio.add("coin", "sounds/supercell.mp3");
    Crafty.audio.add("music", "sounds/music.wav");
    Crafty.audio.add("soundeffect", "sounds/icebeam.wav");
    Crafty.audio.add("shoot", "sounds/flameburst.wav")
    Crafty.audio.add("death", "sounds/death.mp3")
    Crafty.audio.add("finish", "sounds/finish.wav")
    Crafty.audio.play('music',-1,1);
    Crafty.audio.add("kill", "sounds/cenaShort.wav")
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('moveRight', 500, [[0, 2], [1, 2], [2, 2], [3, 2]])
    .reel('moveLeft', 500, [[0, 1], [1, 1], [2, 1], [3, 1]])
    .reel('jump', 500, [[0, 0], [1, 0]])
    .twoway(300, 580)
    .gravity('FloorTile')
    ...
    .bind('KeyDown',
        function(e){
          if(e.key == Crafty.keys.SPACE){
            console.log("pew");
            Crafty.audio.play('soundeffect',1,1);
            var bulletX = this.x;
            var bulletY = this.y-100;
            if(this.currentDirection === RIGHT){
              Crafty.e("Bullet, DOM, 2D, shadow_left, Collision, Tween")
                .attr({x: bulletX, y: bulletY})
                //.color("#FF0000")
                //.image('img/shadowball.png')
                .tween({x: this.x + 3000}, 3000)
                /*
                .onHit('Walker', function(){
                  this.destroy();
                })*/
...
function placeFlag(){
  _flagFinish = false;
  _flag = Crafty.e('Flagpost, 2D, DOM, flag_post, Image, Collision')
    .attr({
      x: (47 * TILE_WIDTH) - (149/2) ,
      y: (9 * TILE_HEIGHT) - 479 ,
      w: 149 ,
      h: 479
    })
    .image('img/OvertheFlagpole.png')
    .onHit('Player', function(hitData) {
      if( !_flagFinish && __STATE.numCoinsToCollect === 0 ){
