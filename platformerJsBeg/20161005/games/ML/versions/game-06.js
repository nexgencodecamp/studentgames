...
var _secondsTotal = 1000000000000;
...
__STATE.currentScore = 9999999999999;
...
var playerSprite = { 'sprites': { 'img/623.png': { tile: 64, tileh: 64, map: { man_left: [0, 1], man_right: [0, 2], jump_right: [6, 4] } } } };
...
function loadBackground () {
  ...
  Crafty.background('#FFFFFF url(img/battlebgMoveFly.png) repeat repeat');
}
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .bind('KeyDown', function(e){
      if(e.key == Crafty.keys.SPACE/* && this.currentDirection === RIGHT*/){
        var xPos = this.x;
        var yPos = this.y;
        Crafty.e("Bullet, 2D, Collision, Color, Tween")
        .attr({
          x: xPos,
          y: yPos,
          w: 100,
