  ...
  },
{
    ...
    "map": [
      [[0,1],[0,1],[0,12],[0,1],[0,8],[0,1],[0,5],[0,1],[0,5],[0,1]],
      [[0,8],[0,1],[0,3],[0,1],[0,6],[0,1],[0,23]],
      [[0,8],[0,19],[0,1],[4,1],[0,4],[0,6],[0,1],[0,4]],
      [[4,1],[0,10],[8,1],[0,11],[0,14],[0,6]],
      [[0,16],[8,1],[0,13],[8,1],[0,11]],
      [[0,9],[4,1],[0,37]],
      [[0,48]],
      [[1,48]]
  ...
  "level": 4,
    "map": [
      [[0,1],[0,1],[0,12],[0,1],[0,8],[4,1],[0,6],[0,1],[8,1],[0,4]],
      [[0,8],[0,1],[0,3],[0,1],[8,1],[0,6],[0,23]],
      [[0,8],[0,19],[0,1],[4,1],[0,4],[0,6],[4,1],[0,5]],
      [[4,1],[0,10],[8,1],[0,11],[0,14],[0,6]],
      [[0,16],[8,1],[0,13],[8,1],[0,11]],
      [[0,9],[4,1],[0,37]],
      [[0,48]],
...
var playerSprite = { 'sprites': { 'img/player.png': { tile: 68, tileh: 80, map: { man_left: [0, 1], man_right: [0, 2], jump_right: [6, 4] } } } };
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('moveRight', 500, [[0, 0], [1, 0], [2, 0], [3, 0], [0, 1], [1, 1], [2, 1], [3, 1]])
    .reel('moveLeft', 500, [[0, 3], [1,3], [2, 3], [3, 3], [0, 4], [1, 4], [2, 4], [3, 4]])
    .reel('still', 500, [[0,2]])
    .twoway(200, 510)
    .gravity('FloorTile')
