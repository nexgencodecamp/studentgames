...
var playerSprite = { 'sprites': { 'img/playerSprite.png': { tile: 68, tileh: 88 , map: { man_left: [0, 1], man_right: [11, 0], jump_right: [6, 4] } } } };
...
function loadBackground () {
  Crafty.background('#3BB9FF url(img/BackGround.png) repeat-x center center ');
}
