...
var tileMap = [
  [8,[1],8,[13],4,[8],8,[5],4,[7],8,[6],8,[2]],
  [[8],8,[3],4,[6],8,[28]],
  [4,[8],[24],4,[3],4,[6],8,[4]],
  [[8],8,8,[3],4,[15],4,[13],4,[6]],
  [4,[8],8,[8],8,[19],8,[11]],
  [[8],8,1,[1],4,[38]],
  [[8],8,1,1,1[39]],
    ...
    tileRow.map(function (tile, tileIdx) {
      ...
      if (tile === 1) {
        Crafty.e('FloorTile, 2D, DOM, Image, Collision')
          ...
          .image(Crafty.assets['img/grassy_' + tile + '.png'].src);
      }
      else if (tile === 4) {
        var t = Crafty.e('Platform', {w: 160}).setImage('img/walkerSprite.png');
        t.position.x = xPos;
        t.position.y = yPos;
        t.placePlatform(1);
