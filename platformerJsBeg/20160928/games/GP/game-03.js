...
var enemySprite = { 'sprites': { 'img/enemySprite.png': { tile: 32, tileh: 32, map: { enemy_left: [2,0], enemy_right: [2, 0]} } } };
initialiseGame();
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_still, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('moveLeft', 500, [[13, 0], [14, 0], [15, 0], [16, 0], [17, 0], [18, 0]])
    .reel('jump', 500, [[11, 0]])
    .reel('still', 500, [[19,0], [20, 0], [21, 0]])
    .twoway(200, 510)
    .gravity('FloorTile')
