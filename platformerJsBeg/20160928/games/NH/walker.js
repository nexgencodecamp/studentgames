...
var walkerSprite = { 'sprites': { 'img/badDudes.png': { tile: 41, tileh: 38, map: { walker_first: [0, 0] } } } };
...
Crafty.c('Walker', {
  ...
  init: function (obj) {
    ...
    this.reel('walkRight', 600, [[18, 0], [17, 0], [16, 0], [15, 0]]);
    this.reel('walkFall', 1000, [[4, 0], [5, 0], [6, 0], [7, 0],[8, 0], [9, 0], [10, 0],[11, 0], [12, 0], [13, 0], [12, 0], [11, 0], [10, 0],[9, 0], [8, 0], [7, 0],[6, 0], [5, 0]]);
    this.reel('dieLeft', 50, [[14, 0]]);
    this.reel('dieRight', 50, [[14, 0]]);
    this.reel('dieFall', 50, [[14, 0]]);
    if(entryPos === 1){
