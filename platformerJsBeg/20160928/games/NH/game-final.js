...
var playerSprite = { 'sprites': { 'img/normalRun.png': { tile: 68, tileh: 80, map: { man_still: [0,0], man_left: [0, 1], man_right: [0, 2], jump_right: [6, 4] } } } };
...
function initialiseGame () {
  Crafty.load(assets, function(){
    ...
    displayText();
    /* Load sounds */
    Crafty.audio.add("coin", "Img/realCoinSound.wav");
    Crafty.audio.add("playerDie", "Img/realDeathSound.wav");
    Crafty.audio.add("walkerDie", "Img/Quack2.wav");
...
function loadBackground () {
  ...
  Crafty.background('#FFFFFF url(img/WMBG.png) repeat-x center center');
}
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_still, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('moveLeft', 500, [[19, 0],[18, 0],[17, 0],[16, 0],[15, 0],[14, 0]])
    .reel('jumpRight', 500, [[6, 0],[7, 0],[8, 0],[9, 0],[8, 0]])
    .reel('jumpLeft', 500, [[13, 0],[12, 0],[11, 0],[10, 0],[11, 0]])
    .reel('still', 500, [[13, 0], [6, 0]])
    .twoway(200, 510)
    .gravity('FloorTile')
...
function spawnWalkers () {
  Crafty.e('Delay').delay(spawnWalker, Crafty.math.randomInt(100, 1000), -1);
}
...
function displayGameOver(){
  ...
  Crafty.e("GameOver, 2D, DOM, Text")
    ...
    .text("BRUH U DED").textColor('#00FFFF').textFont({ size: '36px', weight: 'bold', family: 'Courier New' });
}
...
function displayLevelComplete(){
  ...
  Crafty.e("LevelComplete, 2D, DOM, Text")
    ...
    .text("LEVEL COMPLETE").textColor('#00FFFF').textFont({ size: '36px', weight: 'bold', family: 'Courier New' });
}
