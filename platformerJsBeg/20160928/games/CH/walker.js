...
var walkerSprite = { 'sprites': { 'img/badguy.png': { tile: 85, tileh: 100, map: { walker_first: [0, 0] } } } };
...
Crafty.c('Walker', {
  ...
  init: function (obj) {
    ...
    this.reel('walkLeft', 600, [[2, 2], [2, 1], [2, 2]]);
    this.reel('walkRight', 600, [[1, 1], [0, 1], [0, 1]]);
    this.reel('walkFall', 600, [[0,0], [0, 0], [0, 0]]);
