...
var coinSprite = { 'sprites': { 'img/coinSprite.png': { tile: 32, tileh: 32, map: { coin_first: [0, 0], coin_last: [8, 0] } } } };
      ...
      for (var i = 0; i < Crafty.math.randomInt(1, 1 * this.scaleWidth); i++) {
        Crafty.e('2D, DOM, coin_first, SpriteAnimation, Collision')
          ...
          .onHit('Player', function(){
            ...
            console.log('coins left ' + __STATE.numCoinsToCollect);
            if(__STATE.numCoinsToCollect < 3){
