...
var walkerSprite = { 'sprites': { 'img/Drone.png': { tile: 50, tileh: 98, map: { walker_first: [0, 0] } } } };
...
Crafty.c('Walker', {
  ...
  init: function (obj) {
    ...
    this.reel('walkFall', 600, [[0, 0], [1, 0], [2, 0]]);
    this.reel('dieLeft', 100, [[1, 1]]);
    this.reel('dieRight', 100, [[2, 1]]);
    this.reel('dieFall', 100, [[1, 1]]);
    if(entryPos === 1){
