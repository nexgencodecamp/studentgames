...
var walkerSprite = { 'sprites': { 'img/evilDude.png': { tile: 68, tileh: 80, map: { walker_first: [0, 0] } } } };
...
Crafty.c('Walker', {
  ...
  init: function (obj) {
    ...
    this.reel('walkLeft', 600, [[1, 2], [2, 2], [3, 2], [4, 2], [0, 3], [1, 3], [2, 3]]);
    this.reel('walkRight', 600, [[0, 0], [1, 0], [2, 0], [3, 0], [4, 0], [0, 1], [1, 1], [0, 1], [4, 0], [3, 0], [2, 0], [1, 0]]);
