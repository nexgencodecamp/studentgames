...
var walkerSprite = { 'sprites': { 'img/police (1).png': { tile: 68, tileh: 80, map: { walker_first: [0, 0] } } } };
...
Crafty.c('Walker', {
  ...
  init: function (obj) {
    ...
    this.reel('walkLeft', 100, [[0, 0], [1, 0], [0, 0]]);
    this.reel('walkRight', 100, [[0, 1], [0, 1], [0, 1]]);
    this.reel('walkFall', 100, [[0, 1], [1, 1], [1, 1]]);
