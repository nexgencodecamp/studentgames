...
var _tileMap = [
  {
    ...
    "map": [
      ...
      [[8,8],[0,4],[0,3],[0,4],[0,6],[8, 8],[0,23]],
      [[0,8],[4,19],[0,4],[0,3],[0,4],[4,6],[0, 8],[4,4]],
      [[0,11],[0,4],[0,12],[4,4],[0,14],[0,6]],
      [[0,8], [0,8],[8, 8],[0,8],[0,8] ,[8, 8],[0,8]],
      [[8,1],[0,9],[0,37]],
      [[0,48]],
      [[1,8],[1,8],[0,8],[1,8],[1,8],[1,8]]
    ]
  },
  {
    "level": 2,
    "map": [
      [[0,4]/*[4,1]*/,[0,1],[0,12],[0,1],[0,8],[0,1],[0,5],[0,1],[0,5],[0,1]],
      [[0,8],[0,1],[0,3],[4,1],[4,6],[0,1],[8,23]],
      [[4,1],[0,4]/*[0,8]*/,[0,19],[0,1],[0,3],[0,1],[0,6],[0,1],[0,4]],
      [[0,11],[0,1],[0,12],[4,1],[4,14],[0,6]],
      [[4,16],[8,1],[0,13],[8,1],[0,11]],
      [[0,9],[0,1],[0,37]],
      [[0,48]],
      [[1,48]]
    ]
...
var assets = {'tiles': ['img/tile-1.png', 'img/platformx2.jpg', 'img/platform.jpg', 'img/sun.png', 'img/tile_concrete.jpg', 'img/tile_concrete_floor.jpg']};
var playerSprite = { 'sprites': { 'img/escaper real1.png': { tile: 68, tileh: 80, map: { man_left: [3, 1], man_right: [3, 0] , jump_right: [2, 0], } } } };
...
function initialiseGame () {
  Crafty.load(assets, function(){
    ...
    Crafty.audio.add("coin", "sounds/coin.wav");
      Crafty.audio.add("soundtrack", "sounds/background.wav");
...
function loadBackground () {
  ...
  Crafty.e('BG, 2D, DOM, Image')
    ...
    .image('img/tile_concrete.jpg', 'repeat');
}
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('moveRight', 400, [[3,0] , [0,0] , [1,0] , [0,0]])
    .reel('moveLeft', 400, [[3,1] , [0,1] , [1,1] , [0,1]])
    .reel('jumpRight', 200, [[2,0],[3,0]])
    .reel('jumpLeft', 200, [[2,1] , [3,1]])
    .twoway(200, 510)
    .gravity('FloorTile')
...
function spawnWalkers () {
  Crafty.e('Delay').delay(spawnWalker, Crafty.math.randomInt(2000, 3000), -1);
}
      ...
      if (tileType === 1) {
        for(var i=0; i < tileNum; i++){
          Crafty.e('FloorTile, 2D, DOM, Image, Collision')
            ...
            .image('img/tile_concrete_floor.jpg');
          xPos += 80;
        }
      }
      else{
...
function displayGameOver(){
  ...
  Crafty.e("GameOver, 2D, DOM, Text")
    .attr({ x: 250 - Crafty.viewport._x, y: 250, z:100, w: 300 })
    .text("You Died").textColor('#000000').textFont({ size: '60px', weight: 'bold', family: 'Courier New' });
}

function displaylevelcomplete(){
  if(_STATE.level >= _tilemap.length){
    displayGameComplete();
    return;
  }
}
...
function displayGameComplete(){
  ...
  Crafty.e("GameComplete, 2D, DOM, Text")
    .attr({ x: 320 - Crafty.viewport._x, y: 280, z:100, w: 200 })
    .text("GG").textColor('#000000').textFont({ size: '100px', weight: 'bold', family: 'Courier New' });
}
...
if( !__STATE.gameOver && _player.y >= SCREENHEIGHT ){
  console.log('player fall down, go boom')
