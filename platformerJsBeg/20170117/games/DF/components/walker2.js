...
var walkerSprite = { 'sprites': { 'img/Spikes.png': { tile: 41, tileh: 38, map: { walker_first: [0, 0] } } } };
...
Crafty.c('Walker', {
  ...
  init: function (obj) {
    ...
    this.reel('walkLeft', 600, [[0, 0]]);
    this.reel('walkRight', 600, [[0, 0]]);
    this.reel('walkFall', 600, [[0, 0]]);
