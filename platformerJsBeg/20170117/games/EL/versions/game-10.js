...
var assets = {'tiles': ['img/tile-1.png', 'img/p1.png', 'img/p2.png', 'img/sun.png']};
var playerSprite = { 'sprites': { 'img/JailBreakGuy.png': { tile: 68, tileh: 80, map: { man_left: [0, 1], man_right: [0, 2], jump_right: [6, 4] } } } };
...
function initialiseGame () {
  Crafty.load(assets, function(){
    ...
    Crafty.audio.add("soundtrack", "sounds/mystery.mp3");
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('moveLeft', 500, [[14,0], [15,0], [16,0], [17,0], [18,0], [19,0], [20,0], [21,0], [22,0]])
    .reel('jumpRight', 500, [[13,0], [12,0], [11,0], [10,0]])
    .reel('jumpLeft', 500, [[26,0], [25,0], [24,0], [23,0]])
    .twoway(200, 510)
    .gravity('FloorTile')
    ...
    tileRow.map(function (tile, tileIdx) {
      ...
      if (tileType === 1) {
        for(var i=0; i < tileNum; i++){
          Crafty.e('FloorTile, 2D, DOM, Color, Image, Collision')
...
function displayGameOver(){
  ...
  Crafty.e("GameOver, 2D, DOM, Text")
    ...
    .text("GET GOOD")
    .textColor('rgb 200 , 0 , 10' ).textFont({ size: '36px', weight: 'bold', family: 'Courier New' });
}
...
/*function displayGameComplete(){
  if(Crafty("GameComplete"))
    Crafty("GmeComplete").destroy();


    Crafty.e("GameComplete, 2D, DOM, Text")
      .attr({ x: 310 - Crafty.viewport._x, y: 280, z:100, w: 350 })
      .text(" IT'S "+" GOOOOOD "+" YOU "+" WIN").textColor('#339944').textFont({ size: '36px', weight: 'bold', family: 'Courier New' });
      //var _secondsTimeLimit = N/A;
      //var _secondsTotal = _secondsTimeLimit
...
function displayGameComplete(){
  ...
  __STATE.gameComplete = true;

  Crafty.e("GameComplete, 2D, DOM, Text")
    .attr({ x: 310 - Crafty.viewport._x, y: 280, z:100, w: 350 })
    .text(" IT'S "+" GOOOOOD "+" YOU "+" WIN ").textColor('#339944').textFont({ size: '36px', weight: 'bold', family: 'Courier New' });
  Crafty.e("GameComplete, 2D, DOM, Text")
    .attr({ x: 320 - Crafty.viewport._x, y: 180, z:200, w: 240})
    .text("Created by LUGGY.inc").textColor("#3333FF").textFont({ size: '30px', weight: 'bold', family: 'Courier New'});
...
function reset () {
  ...
  _timeLeftDisplay = "";
  _secondsTotal = 50 - __STATE.level * 5;
