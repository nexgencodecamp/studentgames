...
var assets = {'tiles': ['img/1.png', 'img/2.png', 'img/Importedpiskel.png', 'img/StoneBlock.png', 'img/LargePlatform.png']};
var playerSprite = { 'sprites': { 'img/Alien.png': { tile: 64, tileh: 75, map: { man_left: [3, 0], man_right: [3, 0], jump_right: [5, 0] } } } };
    ...
    tileRow.map(function (tile, tileIdx) {
      ...
      if (tile === 1) {
        Crafty.e('FloorTile, 2D, DOM, Image, Collision')
          ...
          .image(Crafty.assets['img/1.png'].src);
      }
       else if (tile === 2) {
        Crafty.e('FloorTile, 2D, DOM, Image, Collision')
          .attr({ x: xPos, y: yPos, w: TILE_WIDTH, h: TILE_HEIGHT })
        ...
        Crafty.e('FloorTile, 2D, DOM, Image, Collision')
          .attr({ x: xPos, y: yPos, w: TILE_WIDTH, h: TILE_HEIGHT })
          .image(Crafty.assets['img/Importedpiskel.png'].src);
      }
      else if (tile === 4) {
        ...
        var t = Crafty.e('Platform', {w: 320}).setImage('img/LargePlatform.png');
        t.position.x = xPos;
        t.position.y = yPos;
        t.placePlatform(2);
        t.addCoins(Crafty.math.randomInt(1,2));
