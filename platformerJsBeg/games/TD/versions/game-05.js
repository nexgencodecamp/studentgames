...
var tileMap = [
  ...
  [[8],[1],4,[38]],
  [[8],[39]],
  [1,1,19,19,51,91,41,1,71,71,71,71,17,91,91,91,91,91,91,91,91,91,8,91,91,91,91,91,91,81,1,81,81,81,1,81,81,81,81,8,81,81,81,881,81,81,4,61]
];

Crafty.init(800, 600, document.getElementById('gamecanvas'));

var assets = {'tiles': ['img/tile-1.png', 'img/platform.png', 'img/platformx2.png']};
var playerSprite = { 'sprites': { 'img/playerSprite.png': { tile: 60, tileh: 60, map: { man_left: [3, 3], man_right: [0, 1], jump_right: [0, 0] } } } };
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .bind('CheckJumping', function (ground) {
      ...
      this.pauseAnimation();
      this.resetAnimation();
      this.sprite(this.currentDirection === RIGHT ? 3 : 3, 0);
    })
