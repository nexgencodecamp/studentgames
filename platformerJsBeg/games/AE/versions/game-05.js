...
var _tileMap = [
  ...
  },
  {
    ...
    "map": [
      ...
      [[8,1],[8,1],[4,1],[0,3],[0,1],[0,6],[0,1],[0,4]],
      [[0,11],[0,1],[0,12],[0,1],[0,14],[0,6]],
      [[0,16],[8,1],[0,13],[0,5],[0,1]],
      [[0,9],[4,1],[0,37]],
      [[0,48]],
      [[1,48]]
    ]
...
var Memio = { 'sprites': { 'img/Memio.png': { tile: 68, tileh: 80, map: { man_left: [0, 1], man_right: [0, 2], jump_right: [6, 0] } } } };
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('moveLeft', 500, [[12, 0], [13, 0], [14, 0], [15, 0], [16, 0], [17, 0], [18, 0], [19, 0]])
    .reel('stillRight', 500, [[8, 0]])
    .reel('stillLeft', 500, [[20, 0]])
    .twoway(200, 510)
    .gravity('FloorTile')
    ...
    .bind('CheckJumping', function (ground) {
      ...
      this.animate('stillRight');
      this.resetAnimation();
      this.sprite(this.currentDirection === RIGHT ? 11 : 23, 0);
    })
...
function displayTimeLeft () {
  ...
  _timeLeftDisplay = Crafty.e("2D, DOM, Text")
    ...
    .textColor('#FF0000')
    .textFont({ size: '14px', weight: 'bold', family: 'Jokewood' });
}
...
function displayGameOver(){
  ...
  Crafty.e("GameOver, 2D, DOM, Text")
    ...
    .text("GET REKT M8").textColor('#FF0000').textFont({ size: '36px', weight: 'bold', family: 'Bitch Slap' });
}
