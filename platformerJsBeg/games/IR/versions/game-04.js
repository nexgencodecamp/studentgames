...
var playerSprite = { 'sprites': { 'img/player1.png': { tile: 68, tileh: 80, map: { man_left: [9,0], man_right: [8, 0], jump_right: [9, 0] } } } };
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('moveLeft', 500, [[8, 0], [8, 0], [8, 0], [8, 0], [8, 0], [8, 0], [8, 0], [8, 0]])
    .reel('still', 500, [[8,0]])
    .twoway(200, 510)
    .gravity('FloorTile')
