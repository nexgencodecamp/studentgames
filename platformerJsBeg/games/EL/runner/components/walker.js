...
//Crafty.sprite(12, "img/goomba1.png", { Walker: [0,0] });
var walker = { 'sprites': { 'img/allgoombas.png': { tile: 41, tileh: 38, map: { walker_first: [0, 0] } } } };
Crafty.load(walker);
...
Crafty.c('Walker', {
  ...
  init: function (obj) {
    ...
    this.reel('walkLeft', 600, [[2, 5]]);
    this.reel('walkRight', 600, [[0, 1], [1, 1], [2, 1]]);
    this.reel('walkFall', 600, [[1, 3], [2, 3], [3, 3], [0, 4]]);
    this.reel('dieLeft', 100, [[3, 5]]);
    this.reel('dieRight', 100, [[3, 1]]);
    this.reel('dieFall', 100, [[1, 4]]);
    if(entryPos === 1){
