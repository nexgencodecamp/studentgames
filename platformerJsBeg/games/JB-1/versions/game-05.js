...
var _tileMap = [
  {
    ...
    "map": [
      ...
      [[0,8],[0,20],[4,1],[0,3],[4,1],[0,6],[8,1],[0,4]],
      [[0,11],[4,1],[0,12],[4,1],[0,10], [4, 1], [0,6]],
...
var playerSprite = { 'sprites': { 'img/bankrobber2pixel.png': { tile: 68, tileh: 80, map: { man_left: [0, 0], man_right: [0, 0], jump_right: [6, 0] } } } };
...
function initialiseGame () {
  Crafty.load(assets, function(){
    ...
    Crafty.audio.add("music", "sounds/Ridelikethewind.m4p")
...
function loadBackground () {
 ...
 Crafty.background('#FFFFFF url(img/snowbackground.png) repeat-x center center');
}
...
function spawnPlayer (){
  _player = Crafty.e('Player, 2D, DOM, man_right, SpriteAnimation, Twoway, Collision, Gravity, Tween, Keyboard')
    ...
    .reel('moveLeft', 500, [[14, 0], [15, 0], [16, 0], [17, 0], [18, 0], [19, 0], [20, 0], [21, 0]])
    .reel('rightJump', 500, [[10, 0], [11, 0], [12, 0]])
    .reel('leftJump', 500, [[20, 0], [21, 0], [22, 0]])
    .twoway(200, 510)
    .gravity('FloorTile')
    ...
    .bind('CheckJumping', function (ground) {
      ...
      this.pauseAnimation();
      this.resetAnimation();
      this.sprite(this.currentDirection === RIGHT ? this.animate("rightJump") : this.animate("leftJump"));
    })
...
function displayGameOver(){
  ...
  Crafty.e("GameOver, 2D, DOM, Text")
    ...
    .text("SORRY BUD").textColor('#FF0000').textFont({ size: '36px', weight: 'bold', family: 'Courier New' });
}
